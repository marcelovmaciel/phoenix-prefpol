struct SaariBasis{N}
    pool::PreferenceProfiles.CandidatePool
...
function SaariBasis3(pool::PreferenceProfiles.CandidatePool)
...
function SaariBasis4(pool::PreferenceProfiles.CandidatePool)
...
function ranking_labels(b::SaariBasis; sep = ">")
    names = PreferenceProfiles.candidates(b.pool)
